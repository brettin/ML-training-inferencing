...
[ $# -eq 0 ] && {
	echo ""
	echo "Usage: "$(basename $0)" num_inputs (not more than total GPUs)"
	echo ""
	echo "This program takes as input a ile of csv file paths on which to "
	echo "run infer15.py against the V3.April_9 models"A
	echo ""
	exit 1
}
